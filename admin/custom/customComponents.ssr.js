  ...
  async function getExposesMap() {
    exposesMapPromise ??= import("virtual:mf-exposes-ssr:__mfe_internal__AdminComponentEasyAccessSet__customComponents_js").then((mod) => mod.default ?? mod);
  ...
  async function init(shared = {}, initScope = []) {
    ...
    const initToken = { from: "AdminComponentEasyAccessSet" };
